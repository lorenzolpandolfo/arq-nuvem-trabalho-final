...
from customer_service.db.utils import create_database, drop_database
from customer_service.services.rabbit.dependencies import get_rmq_channel_pool
from customer_service.services.rabbit.lifespan import init_rabbit, shutdown_rabbit
from customer_service.settings import settings
from customer_service.web.application import get_app
...
async def _engine(anyio_backend: Any) -> AsyncGenerator[AsyncEngine, None]:
    ...
    from customer_service.db.models import load_all_models
